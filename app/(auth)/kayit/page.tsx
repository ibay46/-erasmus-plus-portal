...
import { registerUser, type RegisterFormState } from "@/lib/actions/auth";
...
export default function KayitPage() {
  ...
  return (
    <Card>
      <h1 className="text-2xl font-semibold mb-6 text-foreground">Hesap Oluştur</h1>
      ...
      <p className="mt-4 text-sm text-muted-foreground">
        ...
        <Link href="/giris" className="cursor-pointer text-accent hover:underline">
          Giriş yapın
        </Link>
      </p>
    </Card>
