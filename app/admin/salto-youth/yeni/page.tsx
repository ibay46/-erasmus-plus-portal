...
export const metadata = { title: "Yeni SALTO Youth Yazısı | Yönetim Paneli" };

export default async function YeniSaltoYouthPage({
  searchParams,
}: {
  ...
  return (
    <div>
      <h1 className="text-2xl font-semibold mb-6 text-foreground">Yeni SALTO Youth Yazısı Ekle</h1>
      <ErrorBanner message={hata} />
      <Card>
        <form action={createPost} className="space-y-4">
          <input type="hidden" name="adminBase" value="/admin/salto-youth" />
          <PostFormFields lockedCategory="SALTO_YOUTH" />
          <button
            type="submit"
