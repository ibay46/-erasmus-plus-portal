...
export const metadata = { title: "ESC Yazısını Düzenle | Yönetim Paneli" };

export default async function EscDuzenlePage({
  params,
  searchParams,
}: {
  ...
  return (
    <div>
      <h1 className="text-2xl font-semibold mb-6 text-foreground">ESC Yazısını Düzenle</h1>
      ...
      <Card>
        <form action={updatePost} className="space-y-4">
          ...
          <PostFormFields defaultValues={post} lockedCategory="ESC" />
