...
export const metadata = { title: "SALTO Education & Training Yazısını Düzenle | Yönetim Paneli" };

export default async function SaltoEgitimDuzenlePage({
  params,
  searchParams,
}: {
  ...
  return (
    <div>
      <h1 className="text-2xl font-semibold mb-6 text-foreground">SALTO Education & Training Yazısını Düzenle</h1>
      ...
      <Card>
        <form action={updatePost} className="space-y-4">
          ...
          <PostFormFields defaultValues={post} lockedCategory="SALTO_EDUCATION_TRAINING" />
